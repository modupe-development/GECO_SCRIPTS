...
# MANUAL FOR fRAV-RAVENinserttranscriptome.pl
...
RAVENinserttranscriptome.pl [--help] [--manual]
...
# #CREATING LOG FILES
my $std_out = '/home/modupe/.LOG/TransRav-'.`date +%m-%d-%y_%T`; chomp $std_out; $std_out = $std_out.'.log';
my $std_err = '/home/modupe/.LOG/TransRav-'.`date +%m-%d-%y_%T`; chomp $std_err; $std_err = $std_err.'.err';
my $jobid = "GECOraven-".`date +%m-%d-%y_%T`;
...
$in1 = "/home/modupe/LAST"; #TRANSFER2";
...
my $STORAGEPATH = "/home/modupe/CHICKENSNPS"; #files are stored in this directory
