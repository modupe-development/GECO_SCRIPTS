...
# MANUAL FOR fRAV-GECOinserttranscriptome.pl
...
# #CREATING LOG FILES
my $std_out = '/home/modupeore17/.LOG/TransRav-'.`date +%m-%d-%y_%T`; chomp $std_out; $std_out = $std_out.'.log';
my $std_err = '/home/modupeore17/.LOG/TransRav-'.`date +%m-%d-%y_%T`; chomp $std_err; $std_err = $std_err.'.err';
...
my $STORAGEPATH = "/storage2/modupeore17/CHICKENvariants"; #files are stored in this directory
